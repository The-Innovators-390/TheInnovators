...
const SCHEDULE: Record<string, ScheduleEntry> = {
  SGW_TO_LOYOLA: {
    ...
    departures: [
      ...
      "14:30","14:45","15:00","15:15","15:30","16:00","16:15","16:45","17:00",
  ...
  LOYOLA_TO_SGW: {
    ...
    departures: [
      ...
      "11:30","11:45","12:30","12:45","13:00","13:15","13:30","13:45","14:00",
      "14:15","14:30","14:45","15:00","15:15","15:30","15:45","16:30","16:45",
  ...
  SGW_TO_LOYOLA_FRIDAY: {
    days: ["Friday"],
    departures: [
      "09:45","10:00","10:15","10:45","11:15","11:30","12:15","12:30","12:45",
      "13:15","13:45","14:00","14:15","14:45","15:00","15:15","15:45","16:00",
  ...
  LOYOLA_TO_SGW_FRIDAY: {
    days: ["Friday"],
    departures: [
      "09:15","09:30","09:45","10:15","10:45","11:00","11:15","12:00","12:15",
      "12:45","13:00","13:15","13:45","14:15","14:30","14:45","15:15","15:30",
...
function encodePolyline(points: LatLng[]): string {
  ...
  for (const { latitude, longitude } of points) {
    ...
    result +=
      encodePolylineValue(lat - prevLat) +
      encodePolylineValue(lng - prevLng);
    prevLat = lat;
    prevLng = lng;
  }
  return result;
